	...
	for(int i = 0; i < b; i++){
		if(alunos[i].matricula == altmatricula){
			...
			cout << "Escolha uma das opcoes a seguir: " << endl
		          << "Digite 1 alterar/inserir a nota da AEP1" << endl
		          << "Digite 2 alterar/inserir a nota da prova1" << endl
		          << "Digite 3 alterar/inserir a nota da AEP2" << endl
		          << "Digite 4 alterar/inserir a nota da prova2" << endl
		          << "Digite 5 alterar/inserir a nota da substitutiva" << endl
